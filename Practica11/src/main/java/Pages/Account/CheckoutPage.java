...
public class CheckoutPage extends Page {
    ...
    public void selectDropdown(String state){
        this.getStateDropdown().click(); //Le damos click al elemento primero
        this.fiendElement(this.getStateDropdown().findElement(By.xpath("//option[normalize-space() = '"+state+"']"))).click(); //REALIZAMOS UNA BUSQUEDA, El state es el parametro que se esta recibiendo de la funcion que es el estado que le vamos a proporcionar
    }

...
public class Page { // ESTA CLASE PAGE CONTENDRA TODAS LAS FUNCIONES QUE NECESITARAN LAS DEMAS CLASES
    ...
    private static final int WAIT_TIMEOUT = 14; //Al ser static final, su valor es constante y no puede ser modificado.
    ...
    public Boolean isTextPresent(final String txt){ //FUNCION PARA BUSCAR TEXTO (String textoQueVamosApasar)

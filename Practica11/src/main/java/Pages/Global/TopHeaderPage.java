...
public class TopHeaderPage extends Page { //ESTA CLASE REPRESETA LA PARTE SUPERIOR DE LA PAGINA, HEREDAMOS LA CLASE PAGE
    ...
    private WebElement createAccountLink; //Almacenamos el elemento en la variable WebElement. Es buena practica poner el tipo de elemento al final
    ...
    public void clickCheckoutButton(){ //TENEMOS ESTA OTRA OPCION PARA NO USARL EL EVENTO .CLICK EN LA PRUEBA
